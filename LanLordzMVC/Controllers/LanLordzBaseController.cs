...
namespace LanLordz.Controllers
{
    ...
    public class LanLordzBaseController : Controller
    {
            ...
            : base()
        {
            ...
            this.Security = new SecurityRepository(this.Db, cache);
            this.Events = new EventRepository(this.Db, cache);
            this.Polls = new PollRepository(this.Db, cache);
            this.Users = new UserRepository(this.Db, cache);
            this.Forums = new ForumRepository(this.Db, cache, this.Security);
        }
        ...
        public PluginRepository Plugins
        {
            get
            {
                ...
                {
                    this.pluginRepo = new PluginRepository(this.Server.MapPath("~/Plugins"), LanLordzBaseController.pluginCache);
                }
        ...
        public SkinRepository Skins
        {
            get
            {
                ...
                {
                    this.skinRepo = new SkinRepository(this.Server.MapPath("~/Skins"), LanLordzBaseController.skinsCache);
                }
